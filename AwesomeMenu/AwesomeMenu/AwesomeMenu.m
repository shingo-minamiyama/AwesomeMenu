...
- (void)_setMenu {
    ...
    for (int i = 0; i < count; i ++)
    {
        ...
        NSInteger tinesCount = (count <= 1) ? 1 : (count - 1);
        CGPoint endPoint = CGPointMake(startPoint.x + endRadius * sinf(i * menuWholeAngle / tinesCount), startPoint.y - endRadius * cosf(i * menuWholeAngle / tinesCount));
        item.endPoint = RotateCGPointAroundCenter(endPoint, startPoint, rotateAngle);
        CGPoint nearPoint = CGPointMake(startPoint.x + nearRadius * sinf(i * menuWholeAngle / tinesCount), startPoint.y - nearRadius * cosf(i * menuWholeAngle / tinesCount));
        item.nearPoint = RotateCGPointAroundCenter(nearPoint, startPoint, rotateAngle);
        CGPoint farPoint = CGPointMake(startPoint.x + farRadius * sinf(i * menuWholeAngle / tinesCount), startPoint.y - farRadius * cosf(i * menuWholeAngle / tinesCount));
